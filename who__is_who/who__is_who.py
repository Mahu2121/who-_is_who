...
def index():
    ...
    rx.box(
            rx.grid(
                ...
                rx.input(on_change=state.set_texto_input,name="adivinarPersonaje", placeholder = "Adivina el personaje aqui", width="550px",margin_left="60%",border_width="3px",margin_top="30px")
                ,rx.button(
                    "Adivinar",
